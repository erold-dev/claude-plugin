...
### Changed
- **Sync now explores codebase** - Automatically scans code to compare with Erold tasks, updates task statuses when code is ahead

## [1.5.2] - 2025-01-26

### Changed
- **Sync command rewritten** - Removed git dependency, now syncs Erold PM ↔ local state only
